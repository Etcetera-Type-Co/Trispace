...
AXES = [
    dict(
        ...
        ordering=0,
        values=[
            dict(nominalValue=75, rangeMinValue=75, rangeMaxValue=85, name="Condensed"),
            dict(nominalValue=87.5, rangeMinValue=85, rangeMaxValue=95, name="SemiCondensed"),
            dict(nominalValue=100, rangeMinValue=95, rangeMaxValue=105, name="Normal", flags=0x2),
            dict(nominalValue=112.5, rangeMinValue=105, rangeMaxValue=115, name="SemiExpanded"),
    ...
    dict(
        ...
        values=[
            ...
            dict(nominalValue=800, rangeMinValue=750, rangeMaxValue=800,name="ExtraBold"),
